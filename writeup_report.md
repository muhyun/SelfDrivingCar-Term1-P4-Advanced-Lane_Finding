...
The code for this step is contained in the second code cell of the IPython notebook located in "adv-lane-finding.ipynb"; _camera_calibration()_.
...
I used a combination of color and gradient thresholds to generate a binary image. _color_gradient_threshold()_ function does this. Here's an example of my output for this step.

![alt text][image3]

#### 3. Describe how (and identify where in your code) you performed a perspective transform and provide an example of a transformed image.

The code for my perspective transform includes a function called `warper()` in adv-lane-finding.ipynb.  The `warper()` function takes as inputs an image (`img`). It initializes source and destination points when it is called for the first time. I chose the hardcode the source and destination points in the following manner:
...
The initial model to find lanes has false positives. The way I fix is 

1) to compare the botoom left x and right x position of the current frame with the previous valid frame
